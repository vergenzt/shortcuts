{
  ...
  WFWorkflowActions: lib.Actions({
    ['Empty Dictionary']: lib.Action('is.workflow.actions.dictionary', {
      ...
      ,
      ['Input As Dict']: lib.Action('is.workflow.actions.detect.dictionary', {
      ...
      ,
      ['Issue key']: lib.Action('is.workflow.actions.conditional', {
      ...
      ,
      ['Get Initial Issue Response']: lib.Action('is.workflow.actions.runworkflow', {
      ...
      ,
      ['Initial Issue Key']: lib.Action('is.workflow.actions.getvalueforkey', {
      ...
      ,
      ['Get Link Types Result']: lib.Action('is.workflow.actions.runworkflow', {
      ...
      ,
      ['Link Type IDs by Inward String']: lib.Action('ke.bou.GizmoPack.QueryJSONIntent', {
      ...
      ,
      ['Chosen String']: lib.Action('is.workflow.actions.choosefromlist', {
      ...
      ,
      ['Link Type ID']: lib.Action('is.workflow.actions.getvalueforkey', {
      ...
      ,
      ['fields.summary']: lib.Action('is.workflow.actions.getvalueforkey', {
      ...
      ,
      ['New Issue Summary']: lib.Action('is.workflow.actions.ask', {
      ...
      ,
      ['Quoted New Issue Summary']: lib.Action('is.workflow.actions.text.replace', {
      ...
      ,
      ['Query']: lib.Action('is.workflow.actions.gettext', {
      ...
      ,
      ['Create Issue Request']: lib.Action('ke.bou.GizmoPack.QueryJSONIntent', {
      ...
      ,
      ['Create Issue Request']: lib.Action('is.workflow.actions.dictionary', {
              CustomOutputName: 'Create Issue Request',
      ...
      ,
      ['Create Issue Result']: lib.Action('is.workflow.actions.runworkflow', {
