{
  ...
  WFWorkflowActions: lib.Actions({
    [lib.anon()]: lib.Action('dk.simonbs.DataJar.CheckIfValueExistsIntent', {
      ...
      ,
      [lib.anon()]: lib.Action('is.workflow.actions.delay', {})
      ,
      [lib.anon()]: lib.Action('dk.simonbs.DataJar.DeleteValueIntent', {
      ...
      ,
      [lib.anon()]: lib.Action('com.alexhay.ToolboxProForShortcuts.QuickMenu2Intent', {
      ...
      ,
      [lib.anon()]: lib.Action('is.workflow.actions.gettypeaction', {
      ...
      ,
      ['Icon Image']: lib.Action('is.workflow.actions.setitemname', {
      ...
      ,
      ['Resized Icon']: lib.Action('is.workflow.actions.image.resize', {
      ...
      ,
      ['rawShortcut']: lib.Action('is.workflow.actions.downloadurl', {
      ...
      ,
      [lib.anon()]: lib.Action('is.workflow.actions.setitemname', {
      ...
      ,
      [lib.anon()]: lib.Action('dk.simonbs.DataJar.GetChildCountIntent', {
      ...
      ,
      [lib.anon()]: lib.Action('dk.simonbs.DataJar.GetKeysIntent', {
        UUID: '93804AA3-E572-4014-A50B-CC9FDC31F2FF',
        keyPath: 'Version Control',
      })
      ,
      [lib.anon()]: lib.Action('com.sindresorhus.Actions.SortListIntent', {
        AppIntentDescriptor: {
      ...
      ,
      [lib.anon()]: lib.Action('is.workflow.actions.showwebpage', {
      ...
      ,
      ['Name']: lib.Action('is.workflow.actions.getvalueforkey', {
      ...
      ,
      ['Version']: lib.Action('is.workflow.actions.getvalueforkey', {
      ...
      ,
      ['Date']: lib.Action('is.workflow.actions.getvalueforkey', {
      ...
      ,
      ['URL']: lib.Action('is.workflow.actions.getvalueforkey', {
      ...
      ,
      ['Note']: lib.Action('is.workflow.actions.getvalueforkey', {
      ...
      ,
      ['Actions']: lib.Action('is.workflow.actions.getvalueforkey', {
      ...
      ,
      [lib.anon()]: lib.Action('is.workflow.actions.getrichtextfrommarkdown', {
      ...
      ,
      [lib.anon()]: lib.Action('com.apple.mobilenotes.SharingExtension', {
        AppIntentDescriptor: {
      ...
      ,
      [lib.anon()]: lib.Action('is.workflow.actions.appendnote', {
        AppIntentDescriptor: {
