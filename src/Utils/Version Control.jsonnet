...

{
  ...
  WFWorkflowActions: sc.ActionsSeq([
    ...
    sc.Action('is.workflow.actions.conditional', {
      ...
      WFInput: {
        Type: 'Variable',
        Variable: sc.Ref(outputs, 'Value Exists', aggs=[
          {
            PropertyName: 'Name',
    ...
    sc.Action('dk.simonbs.DataJar.SetValueIntent', {
      ...
      values: sc.Ref(outputs, 'Dictionary', att=true),
    }),
    ...
    sc.Action('is.workflow.actions.conditional', {
      ...
      WFInput: {
        Type: 'Variable',
        Variable: sc.Ref(outputs, 'Shortcut Input', att=true),
      },
    }),
    ...
    sc.Action('is.workflow.actions.conditional', {
      ...
      WFInput: {
        Type: 'Variable',
        Variable: sc.Ref(outputs, 'If Result', aggs=[
          {
    ...
    sc.Action('is.workflow.actions.gettypeaction', name='File of Type', params={
      ...
      WFInput: sc.Ref(outputs, 'Updated Text', att=true),
    }),

    sc.Action('is.workflow.actions.urlencode', name='URL Encoded Text', params={
      local outputs = super.outputs,
      WFInput: sc.Val('${File of Type}', outputs),
    }),
    ...
    sc.Action('is.workflow.actions.text.replace', name='Updated Text', params={
      ...
      WFInput: sc.Val('${File of Type}', outputs),
      WFReplaceTextFind: '${f}',
      WFReplaceTextReplace: sc.Val('${URL Encoded Text}', outputs),
    }),

    sc.Action('is.workflow.actions.downloadurl', name='Contents of URL', params={
      local outputs = super.outputs,
      WFURL: sc.Val('${Updated Text}', outputs),
    }),

    sc.Action('is.workflow.actions.setitemname', name='Icon Image', params={
      local outputs = super.outputs,
      WFInput: sc.Ref(outputs, 'Contents of URL', att=true),
      WFName: {
        Value: {
          attachmentsByRange: {
            '{0, 1}': sc.Ref(outputs, 'File of Type', aggs=[
              {
    ...
    sc.Action('is.workflow.actions.image.resize', name='Resized Icon', params={
      local outputs = super.outputs,
      WFImage: sc.Ref(outputs, 'Icon Image', att=true),
    ...
    sc.Action('is.workflow.actions.base64encode', name='Base64 Encoded', params={
      ...
      WFEncodeMode: 'Encode',
      WFInput: sc.Ref(outputs, 'Resized Icon', att=true),
    }),
    ...
    sc.Action('is.workflow.actions.setitemname', name='Renamed Item', params={
      local outputs = super.outputs,
      WFInput: sc.Ref(outputs, 'rawShortcut', att=true),
      WFName: 'A.plist',
    }),

    sc.Action('is.workflow.actions.count', name='Count', params={
      local outputs = super.outputs,
      Input: sc.Ref(outputs, 'Renamed Item', aggs=[
        {
          CoercionItemClass: 'WFDictionaryContentItem',
          Type: 'WFCoercionVariableAggrandizement',
        },
    ...
    sc.Action('is.workflow.actions.ask', name='Provided Input', params={
      local outputs = super.outputs,
      WFAskActionDefaultAnswer: sc.Val('${File of Type}', outputs),
    ...
    sc.Action('dk.simonbs.DataJar.GetChildCountIntent', name='Count', params={
      ...
      keyPath: {
        Value: {
          attachmentsByRange: {
            '{16, 1}': sc.Ref(outputs, 'Provided Input'),
          },
    ...
    sc.Action('is.workflow.actions.conditional', {
      ...
      WFInput: {
        Type: 'Variable',
        Variable: sc.Ref(outputs, 'Count', att=true),
      },
      WFNumberValue: '0',
    }),
          ...
          WFDictionaryFieldValueItems: [
            {
              WFItemType: 0,
              WFKey: sc.Val('name'),
              WFValue: sc.Val('${Provided Input}', outputs),
            },
            {
              WFItemType: 0,
              WFKey: sc.Val('version'),
              WFValue: sc.Val('${Value}', outputs),
            },
            {
              WFItemType: 0,
              WFKey: sc.Val('url'),
            ...
            },
            {
              ...
              WFValue: sc.Val('${Count}', outputs),
            },
            {
              WFItemType: 0,
              WFKey: sc.Val('b64icon'),
              WFValue: sc.Val('${Base64 Encoded}', outputs),
            },
          ],
        },
        WFSerializationType: 'WFDictionaryFieldValue',
    ...
    sc.Action('is.workflow.actions.math', name='Calculation Result', params={
      local outputs = super.outputs,
      WFInput: sc.Ref(outputs, 'Count', att=true),
      WFMathOperand: '1',
    }),
    ...
    sc.Action('dk.simonbs.DataJar.SetValueIntent', {
      ...
      keyPath: {
        Value: {
          attachmentsByRange: {
            '{16, 1}': sc.Ref(outputs, 'Dictionary', aggs=[
              {
                DictionaryKey: 'name',
                Type: 'WFDictionaryValueVariableAggrandizement',
              },
            ]),
            '{18, 1}': sc.Ref(outputs, 'Calculation Result'),
          },
          string: 'Version Control.￼.￼',
        },
        WFSerializationType: 'WFTextTokenString',
    ...
    sc.Action('dk.simonbs.DataJar.SetValueIntent', {
      ...
      overwriteStrategy: 'alwaysAllow',
      values: sc.Ref(outputs, 'Resized Icon', att=true),
    }),
    ...
    sc.Action('dk.simonbs.DataJar.SetValueIntent', {
      ...
      overwriteStrategy: 'alwaysAllow',
      values: sc.Ref(outputs, 'Icon Image', att=true),
    }),
    ...
    sc.Action('is.workflow.actions.conditional', {
      ...
      WFInput: {
        Type: 'Variable',
        Variable: sc.Ref(outputs, 'Chosen Item', aggs=[
          {
            PropertyName: 'title',
            Type: 'WFPropertyVariableAggrandizement',
          },
    ...
    sc.Action('com.sindresorhus.Actions.SortListIntent', name='Sorted List', params={
      ...
      'Show-list': true,
      list: sc.Ref(outputs, 'Keys', att=true),
    }),
    ...
    sc.Action('is.workflow.actions.repeat.each', {
      ...
      WFControlFlowMode: 0,
      WFInput: sc.Ref(outputs, 'Sorted List', att=true),
    }),
    ...
    sc.Action('dk.simonbs.DataJar.GetValueIntent', name='Value', params={
      keyPath: {
        Value: {
          attachmentsByRange: {
            '{16, 1}': sc.Ref(outputs, 'Vars.Repeat Item'),
          },
    ...
    sc.Action('is.workflow.actions.gettext', name='Text', params={
      ...
      WFTextActionText: {
        Value: {
          attachmentsByRange: {
            '{17, 1}': sc.Ref(outputs, 'Value', aggs=[
              {
                CoercionItemClass: 'WFStringContentItem',
                Type: 'WFCoercionVariableAggrandizement',
              },
    ...
    sc.Action('dk.simonbs.DataJar.GetValueIntent', name='Value', params={
      ...
      keyPath: {
        Value: {
          attachmentsByRange: {
            '{16, 1}': sc.Ref(outputs, 'Chosen Item', aggs=[
              {
                PropertyName: 'title',
                Type: 'WFPropertyVariableAggrandizement',
              },
    ...
    sc.Action('dk.simonbs.DataJar.GetValueIntent', name='Value', params={
      ...
      keyPath: {
        Value: {
          attachmentsByRange: {
            '{16, 1}': sc.Ref(outputs, 'Chosen Item'),
            '{18, 1}': sc.Ref(outputs, 'Vars.Repeat Index'),
          },
          string: 'Version Control.￼.￼',
        },
        WFSerializationType: 'WFTextTokenString',
    ...
    sc.Action('is.workflow.actions.gettext', name='Text', params={
      ...
      WFTextActionText: {
        Value: {
          attachmentsByRange: {
            '{11, 1}': sc.Ref(outputs, 'Value', aggs=[
              {
                CoercionItemClass: 'WFDictionaryContentItem',
                Type: 'WFCoercionVariableAggrandizement',
              },
            ...
            '{27, 1}': sc.Ref(outputs, 'Value', aggs=[
              {
                CoercionItemClass: 'WFDictionaryContentItem',
                Type: 'WFCoercionVariableAggrandizement',
              },
            ...
            '{31, 1}': sc.Ref(outputs, 'Value', aggs=[
              {
                CoercionItemClass: 'WFDictionaryContentItem',
                Type: 'WFCoercionVariableAggrandizement',
              },
            ...
            '{41, 1}': sc.Ref(outputs, 'Value', aggs=[
              {
                CoercionItemClass: 'WFDictionaryContentItem',
                Type: 'WFCoercionVariableAggrandizement',
              },
    ...
    sc.Action('is.workflow.actions.choosefromlist', name='Chosen Item', params={
      ...
      WFChooseFromListActionPrompt: {
        Value: {
          attachmentsByRange: {
            '{17, 1}': sc.Ref(outputs, 'Chosen Item'),
          },
          string: 'Which version of ￼ would you like to restore?',
        },
        WFSerializationType: 'WFTextTokenString',
      },
      WFInput: sc.Ref(outputs, 'Vars.Menu', att=true),
    }),
    ...
    sc.Action('is.workflow.actions.text.split', name='Split Text', params={
      ...
      text: sc.Ref(outputs, 'Chosen Item', att=true),
    }),
    ...
    sc.Action('is.workflow.actions.text.replace', name='Updated Text', params={
      local outputs = super.outputs,
      WFInput: sc.Val('${Item from List}', outputs),
      WFReplaceTextFind: '\\s$',
    ...
    sc.Action('is.workflow.actions.conditional', {
      ...
      WFCondition: 4,
      WFConditionalActionString: sc.Val('${Value}', outputs),
      WFControlFlowMode: 0,
      WFInput: {
        Type: 'Variable',
        Variable: sc.Ref(outputs, 'Updated Text', att=true),
      },
    }),
    ...
    sc.Action('is.workflow.actions.repeat.each', {
      ...
      WFControlFlowMode: 0,
      WFInput: sc.Ref(outputs, 'Vars.Export', att=true),
    }),
    ...
    sc.Action('is.workflow.actions.gettext', name='Text', params={
      ...
      WFTextActionText: {
        Value: {
          attachmentsByRange: {
            '{0, 1}': sc.Ref(outputs, 'Date'),
            '{11, 1}': sc.Ref(outputs, 'URL'),
            '{16, 1}': sc.Ref(outputs, 'Actions'),
            '{26, 1}': sc.Ref(outputs, 'Note'),
            '{3, 1}': sc.Ref(outputs, 'Name'),
            '{8, 1}': sc.Ref(outputs, 'Version'),
          },
          string: '￼\n[￼ : v￼](￼) : ￼ Actions\n￼\n\n-',
        },
        WFSerializationType: 'WFTextTokenString',
    ...
    sc.Action('com.apple.mobilenotes.SharingExtension', name='Note', params={
      ...
      folder: sc.Ref(outputs, 'Text', att=true),
    }),
    ...
    sc.Action('is.workflow.actions.appendnote', {
      ...
      WFInput: sc.Val('${Repeat Results}', outputs),
      WFNote: sc.Ref(outputs, 'Note', att=true),
    }),
      ...
      WFTextActionText: {
        Value: {
          attachmentsByRange: {
            ...
            '{52, 1}': sc.Ref(outputs, 'Value', aggs=[
              {
                CoercionItemClass: 'WFDictionaryContentItem',
                Type: 'WFCoercionVariableAggrandizement',
              },
            ...
            '{63, 1}': sc.Ref(outputs, 'Value', aggs=[
              {
                CoercionItemClass: 'WFDictionaryContentItem',
                Type: 'WFCoercionVariableAggrandizement',
              },
    ...
    sc.Action('is.workflow.actions.text.split', name='Split Text', params={
      ...
      WFTextCustomSeparator: ':',
      WFTextSeparator: 'Custom',
      text: sc.Ref(outputs, 'Vars.Repeat Item', att=true),
    }),
    ...
    sc.Action('is.workflow.actions.conditional', {
      ...
      WFInput: {
        Type: 'Variable',
        Variable: sc.Ref(outputs, 'Vars.Deleted', att=true),
      },
      WFNumberValue: '1',
    }),
      ...
      keyPath: {
        Value: {
          attachmentsByRange: {
            ...
            '{18, 1}': sc.Ref(outputs, 'Vars.Repeat Index 2'),
          },
          string: 'Version Control.￼.￼.version',
        },
        WFSerializationType: 'WFTextTokenString',
    ...
    sc.Action('is.workflow.actions.setvariable', {
      local outputs = super.outputs,
      WFInput: sc.Ref(outputs, 'Number', att=true),
