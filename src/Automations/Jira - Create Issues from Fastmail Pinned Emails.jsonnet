{
  ...
  WFWorkflowActions: lib.Actions({
    ['Jira API Config']: lib.Action('is.workflow.actions.runworkflow', {
      ...
      ,
      ['Fastmail Auth']: lib.Action('is.workflow.actions.runworkflow', {
      ...
      ,
      ['from']: lib.Action('is.workflow.actions.getvalueforkey', {
      ...
      ,
      ['from[0]']: lib.Action('is.workflow.actions.getitemfromlist', {
      ...
      ,
      ['From']: lib.Action('is.workflow.actions.conditional', {
              CustomOutputName: 'From',
              GroupingIdentifier: 'C8492311-4C65-4A50-BAA1-5C18CAC7EF4F',
      ...
      ,
      ['messageId']: lib.Action('is.workflow.actions.getitemfromlist', {
