...

{
  ...
  WFWorkflowActions: lib.Actions({
    ...
    [_()]: lib.Action('dk.simonbs.DataJar.GetValueIntent', label='Constants', params={
      UUID: '27964F98-77F2-4D55-996B-92A1F7739C55',
      keyPath: 'Jira - Reopen Recurring Tasks',
    }),

    [_()]: lib.Action('is.workflow.actions.urlencode', label='JQL', params={
    ...
    [_()]: lib.Action('is.workflow.actions.runworkflow', label='Search Issues Result', params={
    ...
    [_()]: lib.Action('is.workflow.actions.getvalueforkey', label='Reopen Basis Option ID', params={
    ...
    [_()]: lib.Action('is.workflow.actions.getvalueforkey', label='Reopen Delay', params={
    ...
    [_()]: lib.Action('is.workflow.actions.getvalueforkey', label='Reopen Basis Field Key', params={
    ...
    [_()]: lib.Action('is.workflow.actions.getvalueforkey', label='Reopen Basis Field Value', params={
    ...
    [_()]: lib.Action('is.workflow.actions.detect.date', label='Reopen Basis Date', params={
    ...
    [_()]: lib.Action('is.workflow.actions.adjustdate', label='New Start Date', params={
    ...
    [_()]: lib.Action('is.workflow.actions.getvalueforkey', label='Due Date', params={
    ...
    [_()]: lib.Action('is.workflow.actions.getvalueforkey', label='Start Date', params={
    ...
    [_()]: lib.Action('is.workflow.actions.adjustdate', label='New Due Date', params={
    ...
    [_()]: lib.Action('is.workflow.actions.dictionary', label='Issue Edit Dictionary', params={
    ...
    [_()]: lib.Action('is.workflow.actions.setvalueforkey', label='Fields Dictionary', params={
