{
  ...
  WFWorkflowActions: lib.Actions({
    ['config']: lib.Action('dk.simonbs.DataJar.GetValueIntent', {
              CustomOutputName: 'config',
              UUID: '84D26323-BCD6-4B0A-B5AF-B5DD07DC4D47',
              keyPath: 'google-oauth',
            })
      ,
      ['existing unexpired token']: lib.Action('ke.bou.GizmoPack.QueryJSONIntent', {
      ...
      ,
      ['refresh_uri']: lib.Action('ke.bou.GizmoPack.QueryJSONIntent', {
      ...
      ,
      ['refresh_result']: lib.Action('is.workflow.actions.downloadurl', {
      ...
      ,
      ['timestamped_token']: lib.Action('ke.bou.GizmoPack.QueryJSONIntent', {
      ...
      ,
      ['auth_params']: lib.Action('is.workflow.actions.dictionary', {
      ...
      ,
      ['auth_uri']: lib.Action('ke.bou.GizmoPack.QueryJSONIntent', {
      ...
      ,
      [lib.anon()]: lib.Action('is.workflow.actions.openxcallbackurl', {
      ...
      ,
      ['result']: lib.Action('is.workflow.actions.detect.dictionary', {
      ...
      ,
      ['token_params']: lib.Action('is.workflow.actions.dictionary', {
      ...
      ,
      ['token_uri']: lib.Action('ke.bou.GizmoPack.QueryJSONIntent', {
      ...
      ,
      ['token']: lib.Action('is.workflow.actions.downloadurl', {
              Advanced: true,
