{
  ...
  WFWorkflowActions: lib.Actions({
    ['Input Dict']: lib.Action('is.workflow.actions.detect.dictionary', {
      ...
      ['Request Method']: lib.Action('is.workflow.actions.getvalueforkey', {
      ...
      ,
      ['Toggl Track API Token']: lib.Action('dk.simonbs.DataJar.GetValueIntent', {
      ...
      ,
      ['Query Params']: lib.Action('is.workflow.actions.getvalueforkey', {
      ...
      ,
      ['Key']: lib.Action('is.workflow.actions.urlencode', {
      ...
      ,
      ['Value']: lib.Action('is.workflow.actions.getvalueforkey', {
      ...
      ,
      ['Value']: lib.Action('is.workflow.actions.urlencode', {
              CustomOutputName: 'Value',
      ...
      ,
      ['Query']: lib.Action('is.workflow.actions.conditional', {
      ...
      ,
      ['Combined URL']: lib.Action('is.workflow.actions.text.combine', {
