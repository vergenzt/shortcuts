{
  ...
  WFWorkflowActions: lib.Actions({
    ['Encoded URL']: lib.Action('is.workflow.actions.urlencode', {
      ...
      ,
      ['Archive Save URL']: lib.Action('is.workflow.actions.gettext', {
      ...
      ,
      ['Archive Root URL']: lib.Action('is.workflow.actions.gettext', {
      ...
      ,
      [lib.anon()]: lib.Action('is.workflow.actions.url.getheaders', {
      ...
      ,
      ['Link Header']: lib.Action('is.workflow.actions.getvalueforkey', {
      ...
      ,
      ['Link Header Matches']: lib.Action('is.workflow.actions.text.match', {
      ...
      ,
      ['Archive URL']: lib.Action('is.workflow.actions.text.match.getgroup', {
